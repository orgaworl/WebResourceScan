...
def plot_resource_mix_by_industry(df: pd.DataFrame, out_dir: str) -> None:
    ...
    ax.legend(loc="lower right", frameon=False, fontsize=12, ncol=4)
...
def plot_script_ratio_boxplot(df: pd.DataFrame, out_dir: str) -> None:
    ...
    for i, d in enumerate(data):
        ...
        ax.text(i + 1, med + 0.03, f"{med:.2f}", ha="center", fontsize=11, color="#333333")
...
def plot_resource_count_scatter(df: pd.DataFrame, out_dir: str) -> None:
    ...
    ax.legend(handles=handles, frameon=False, fontsize=11, ncol=3, loc="upper right")
